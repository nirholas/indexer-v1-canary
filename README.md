...
Test whether an indexer preserves Message.config instead of silently downgrading v1.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Indexer V1 Canary explores a focused consumer use of that space while making the wire budget visible.
